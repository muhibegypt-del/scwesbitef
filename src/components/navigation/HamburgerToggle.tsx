...
export function HamburgerToggle({ isOpen, toggle }: HamburgerToggleProps) {
    return (
        <button
            ...
            className="relative h-10 w-10 rounded-lg bg-white/10 hover:bg-white/20 transition-colors flex flex-col justify-center items-center gap-1.5 lg:hidden z-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-400"
        >
