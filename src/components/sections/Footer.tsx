        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="md:text-right">
            ...
            <div className="space-y-4 md:flex md:flex-col md:items-end">
              <a href="mailto:Info@soulcaravanfoundation.org" className="flex items-center gap-4 text-teal-200/60 hover:text-white transition-colors group focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-500 rounded-sm">
                <Mail className="h-5 w-5 text-olive-400/80 group-hover:text-olive-400 transition-colors" />
                <span className="text-sm">Info@soulcaravanfoundation.org</span>
              </a>
